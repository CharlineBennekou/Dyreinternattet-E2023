...
namespace Dyreinternattet_Semesterprojekt_Vinter_2023.Data
{
    public class MockFrivillig
    {
        ...
        {
            new Frivillige("Stine", "2000-11-28", "Kongevej 22 Hellerup", 4665, "35278071", "stinehellerup@gmail.com", "Jeg elsker dyr."),
            new Frivillige("Thomas", "1995-02-15", "Jordbærdgade 84, Næstved", 6025, "65748394", "thomasjordbær@gmail.com", "Jeg har boet på en gård hele mit liv.")
        };
